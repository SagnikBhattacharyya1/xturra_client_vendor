...
class VDcontacts extends StatefulWidget {
  const VDcontacts({super.key});

  @override
  State<VDcontacts> createState() => _VDcontactsState();
}

class _VDcontactsState extends State<VDcontacts> {
          ...
          children: [
            ...
            Container(
              ...
              child: Wrap(
                ...
                spacing: 10.0,
                children: [
                  Text(StringManager.servicesText,style: GoogleFonts.ibmPlexSans(fontSize: 16,color: Colors.white60),),
                  Text(StringManager.abouText,style: GoogleFonts.ibmPlexSans(fontSize: 16,color: Colors.white60),),
                  Text(StringManager.photosText,style: GoogleFonts.ibmPlexSans(fontSize: 16,color: Colors.white60),),
                  Text(StringManager.filesText,style: GoogleFonts.ibmPlexSans(fontSize: 16,color: Colors.white60),),
                  Text(StringManager.jobsText,style: GoogleFonts.ibmPlexSans(fontSize: 16,color: Colors.white60),),
                  Text(StringManager.contText,style: GoogleFonts.ibmPlexSans(fontSize: 16,color: Colors.white60),),
                ],
              ),
            ),
            Stack(
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Text(StringManager.bigContText,
              ...
              child: Row(
                children: [
                  ...
                  onTap: (){
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => RequestaQuotes()),
                    );
                  },
                  child: Container(
                    margin:EdgeInsets.only(left: 15),
                      child: Text(StringManager.reqQuoText,style: GoogleFonts.ibmPlexSans(color: Colors.white,fontSize: 16),)),
                ),
                  SizedBox(width: 160,),
                  InkWell(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => PlusIcon()),
                      );
                    },
                    child: Stack(
                      children: [
                ...
                children: [
                  InkWell(
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => QuickQuotes()),
                      );
                    },
                    child: Container(
                        margin:EdgeInsets.only(left: 15),
                        child: Text(StringManager.quickQuoText,style: GoogleFonts.ibmPlexSans(color: Colors.white,fontSize: 16),)),
                  ),
                  SizedBox(width: 190,),
                  InkWell(
                    onTap: (){
                    ...
                    children: [
                      Container(
                        margin:EdgeInsets.only(top:16,left: 10),
                          child: Text(StringManager.sendJobText,style: GoogleFonts.ibmPlexSans(fontSize: 15,color: Colors.white),)),
                      SizedBox(height: 20,),
                      Container(
                        margin:EdgeInsets.only(left: 10),
                        child: InkWell(
                          ...
                          child: Center(
                            child: Text("Send",style: GoogleFonts.ibmPlexSans(fontSize: 10,color: Colors.white)
                              ,),
                          )
                            ,)
                          ,),
