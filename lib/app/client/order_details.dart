              ...
              children: [
                Row(
                  children: [
                    ...
                    Column(
                      children: [
                        Text("Orders Details", style: TextStyle(color: Colors.white,
              ...
              Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Center(child: Text(StringManager.ac, style: TextStyle( color: Colors.white,),)),
                  ),
                  SizedBox(height: 10),
                  Container(
                    width: 310,
                    ...
                    child: Center(child: Text(StringManager.dec, style: TextStyle( color: Colors.white,),)),
                  ),
                  SizedBox(height: 30),
                ],
              ),
