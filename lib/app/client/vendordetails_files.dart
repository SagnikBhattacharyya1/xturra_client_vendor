...
class VDfiles extends StatefulWidget {
  const VDfiles({super.key});

  @override
  State<VDfiles> createState() => _VDfilesState();
}

class _VDfilesState extends State<VDfiles> {
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Text(StringManager.bigFilesText,
                ...
                return Column(
                  ...
                  children: [
                    ListTile(
                      ...
                      title: Text("Demo file.pdf",style: GoogleFonts.ibmPlexSans(color:Colors.white,fontSize: 14)),
                      trailing: InkWell(
                        onTap: (){},
                        child: Container(
                          height: 30,
                          ...
                          child: Row(
                            children: [
                              SizedBox(width: 15,),
                              Text("Send",style: GoogleFonts.ibmPlexSans(fontSize: 12,color: Colors.white),),
                              SizedBox(width: 5,),
