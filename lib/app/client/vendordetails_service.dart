...
class VDServices extends StatefulWidget {
  const VDServices({super.key});

  @override
  State<VDServices> createState() => _VDServicesState();
}
//Common part :

class _VDServicesState extends State<VDServices> {
      ...
      body: SingleChildScrollView(
        ...
        child: TextField(
          decoration: InputDecoration(
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Text(StringManager.bestServText,
                ...
                children: [
                  Container(
                    ...
                    child: Column(children: [
                      Container(
                          margin:EdgeInsets.only(bottom: 5,top: 5,right: 15),
                          child: Text(StringManager.transText,
                            style: GoogleFonts.ibmPlexSans(color: Colors.white,fontSize: 16),)),
                      Container(
                        margin: EdgeInsets.only(left:5,bottom: 5),
                        child: Row(
                          children: [
                            Text(StringManager.subAusText,
                          ...
                          children: [
                            Stack(children: [
                              ...
                              Positioned(
                                  top: 3,
                                  left: 3.5,
                                  child: Icon(Icons.percent_rounded, color: Colors.white,size: 8))
                            ]),
                            SizedBox(width: 5,),
                            Text(StringManager.discountText,style: GoogleFonts.ibmPlexSans(fontSize: 12,color: Colors.orangeAccent),),
                          ],
                        ),
                      )
                      ...
                      children:[
                        ...
                        Positioned(
                            ...
                            child: Container(
                              ...
                              child: Container(
                                  margin: EdgeInsets.only(left: 2.5,top: 1),
                                  child: Text("Book Now",style: GoogleFonts.ibmPlexSans(fontSize: 10,color: Colors.white),)),
            ...
            Container(
            margin:EdgeInsets.only(top: 5,),child: DottedDivider(),),
