...
class VDjobs extends StatefulWidget {
  const VDjobs({super.key});

  @override
  State<VDjobs> createState() => _VDjobsState();
}

class _VDjobsState extends State<VDjobs> {
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Text(StringManager.bigJobsText,
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Wrap(
                      ...
                      spacing: 4.0,
                      children: [
                        Text("Send CV/Resume ",style: GoogleFonts.ibmPlexSans(fontSize: 16,color: Colors.white),),
                      ],),
                  ),
                  SizedBox(width: 75,),
                  InkWell(
                      ...
                      child: Row(children: [
                        ...
                        Container(
                          margin:EdgeInsets.only(bottom: 2,left: 3),
                            child: Text("Apply",style: GoogleFonts.ibmPlexSans(color: Colors.white,fontSize: 10),)),
                        SizedBox(width: 3,),
                        Container(
                            margin:EdgeInsets.only(top:2),
                            child: Icon(Icons.arrow_forward_ios_rounded,size: 10,color: Colors.white,))
                      ],),
                    ),
                  )
                ],
                            ...
                            children: [
                              Container(
                                margin:EdgeInsets.only(right:120),
                                  child: Text("Assistant Manager",style:GoogleFonts.ibmPlexSans(fontSize:16,color: Colors.white),)),
                              SizedBox(height: 3,),
                              Container(
                                ...
                                child: Container(
                                  margin:EdgeInsets.only(top:4,left: 5),
                                    child: Text("Full Time",style: GoogleFonts.ibmPlexSans(color: Colors.white,fontSize: 8),)),
                              )
                            ],
