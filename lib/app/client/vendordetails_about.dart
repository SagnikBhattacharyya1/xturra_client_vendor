...
class VDabout extends StatefulWidget {
  const VDabout({super.key});

  @override
  State<VDabout> createState() => _VDaboutState();
}


class _VDaboutState extends State<VDabout> {
  ...
  List<String> paragraphLines = [
    'Lorem Ipsum is simply dummy text of the printing and typesetting industry,Lorem Ipsum has been the industrys standard dummy ext ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.',
  ...
  final List<String> paragraphLines2=[
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Text(StringManager.bigAboutText,
            ...
            Container(
              ...
              decoration: BoxDecoration(
              border: Border.all(color: Colors.black), // Add a border for visualization
              ),
              child: Column(
          children: paragraphLines
              .map((line) => Text(
            line,
            style: GoogleFonts.ibmPlexSans(fontSize: 12,color: Colors.white), // Customize the text style
          ))
              .toList(),
        ),
             ),
                  ...
                  children: [
                    Container(
                      margin: EdgeInsets.only(right: 115,top: 5),
                        child: Text(StringManager.about2Text,style: GoogleFonts.ibmPlexSans(color: Colors.white,fontSize: 18,fontWeight: FontWeight.w500),)),
                    Container(
                      height: 300,
                      child: ListView.builder(
                        itemCount: 3,
                        itemBuilder: (context,index){
                          return ListTile(
                            leading: Container(
                              margin: EdgeInsets.only(bottom: 60,left: 15),
                                child: Icon(Icons.circle,size: 9,color: Colors.blueAccent,)),
                            title: Container(
                              margin: EdgeInsets.only(top: 5,),
                              child: Column(
                                children: paragraphLines2
                                    .map((line) => Text(
                                  line,
                                  style: GoogleFonts.ibmPlexSans(fontSize: 12,color: Colors.white), // Customize the text style
                                ))
